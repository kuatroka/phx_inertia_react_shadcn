...
#
#     PHX_SERVER=true bin/elixir_phoenix_inertia_react_typescript start
#
...
if config_env() == :prod do
  database_path =
    System.get_env("DATABASE_PATH") ||
      ...
      For example: /etc/elixir_phoenix_inertia_react_typescript/elixir_phoenix_inertia_react_typescript.db
      """
